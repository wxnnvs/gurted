...
local function deleteRecord(recordId)
    ...
    local response = fetch('gurt://49.12.6.233:8080/domain/' .. domainName .. '/records/' .. recordId, {
        method = 'DELETE',
        headers = {
...
loadRecords = function()
    ...
    local response = fetch('gurt://49.12.6.233:8080/domain/' .. domainName .. '/records', {
        headers = {
            Authorization = 'Bearer ' .. authToken
        }
    })
...
local function loadDomain()
    ...
    local response = fetch('gurt://49.12.6.233:8080/domain/' .. domainName, {
        headers = {
            Authorization = 'Bearer ' .. authToken
        }
    })
