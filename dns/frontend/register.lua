...
local function loadTLDs()
    ...
    local response = fetch('gurt://49.12.6.233:8080/tlds')
...
local function checkAuth()
    ...
    if authToken then
        ...
        local response = fetch('gurt://49.12.6.233:8080/auth/me', {
            headers = {
...
local function submitDomain(name, tld)
    ...
    local response = fetch('gurt://49.12.6.233:8080/domain', {
        method = 'POST',
        headers = { 
...
local function createInvite()
    ...
    local response = fetch('gurt://49.12.6.233:8080/auth/invite', { 
        method = 'POST',
        headers = {
            Authorization = 'Bearer ' .. authToken
        }
...
local function redeemInvite(code)
    ...
    local response = fetch('gurt://49.12.6.233:8080/auth/redeem-invite', {
        method = 'POST',
        headers = { 
            ['Content-Type'] = 'application/json',
            Authorization = 'Bearer ' .. authToken
